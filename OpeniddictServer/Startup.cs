...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        var endpointOptions = Configuration.GetSection(EndpointsOptions.Position).Get<EndpointsOptions>();
        services.Configure<EndpointsOptions>(Configuration.GetSection(EndpointsOptions.Position));
        ...
        //});
            ...
            .AddServer(options =>
            {
                ...
                options.SetIssuer(endpointOptions.IssuerUri)
                       ...
                       .SetTokenEndpointUris(endpointOptions.TokenUris)
                       .SetLogoutEndpointUris(endpointOptions.LogoutUris)
                       .SetUserinfoEndpointUris(endpointOptions.UserInfoUris)
                       .SetVerificationEndpointUris(endpointOptions.VerifyUris)
               ;
